Feature: "Esqueci a senha"
    ...
    Scenario: desistir de enviar email para modificação de senha
        Given que estou na página de "forgot-password"
        When eu preencho o campo de email com "zsmn@cin.ufpe.br" e clico em "Voltar"
    ...
    Scenario: modificação de senha
        Given existe um usuário cadastrado com email "zsmn@cin.ufpe.br" e senha "A1234567"
        Given que estou na página de "update-password" com email "zsmn@cin.ufpe.br"
